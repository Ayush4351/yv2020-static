...
<head>
    ...
    <!-- Webpage Title -->
    <title>Competitions > Technical | YouthVibe - LPU's Global Open Fest</title>
                    ...
                    <div class="event event--user">
                        <div class="event__item">
                            <div class="event__deco">
                                <div class="event__name">Codzilla/Code Crusher</div>
                            </div>
                            <ul class="event__details-list">
                                <li class="event__detail">Date & Time - 14-02-2020 | 9:00</li>
                                <li class="event__detail">Venue - Block 29 - 304</li>
                            </ul>
            ...
            <div class="col-md-4">
                <section class="pricing-section bg-12">
                    <div class="event event--user">
                        <div class="event__item">
                            <div class="event__deco">
                                <div class="event__name">Web Tactics</div>
                            </div>
                            <ul class="event__details-list">
                                <li class="event__detail">Date & Time - 14-02-2020 | 15:00</li>
                                <li class="event__detail">Venue - Block 14 Lab - 312, 313, 414, 415</li>
                            </ul>
                            <a onclick="reg_closed()" class="event__action">Register <i class="lni-add-file size-xs"></i></a>
                            <a href="https://vormiir.com/yv/rule_book/technical/CodeZilla.pdf" target="_blank" class="event__action">Rule Book <i class="lni-download size-xs"></i></a>
                        </div>
            ...
            <div class="col-md-4">
                <section class="pricing-section bg-12">
                    <div class="event event--user">
                        <div class="event__item">
                            <div class="event__deco">
                                <div class="event__name">RC Plane (Sky High)</div>
                            </div>
                            <ul class="event__details-list">
                                <li class="event__detail">Date & Time - 14-02-2020 | 9:00</li>
                                <li class="event__detail">Venue - BH-4 Ground</li>
                            </ul>
                            <a onclick="reg_closed()" class="event__action">Register <i class="lni-add-file size-xs"></i></a>
                            <a href="https://vormiir.com/yv/rule_book/technical/CodeZilla.pdf" target="_blank" class="event__action">Rule Book <i class="lni-download size-xs"></i></a>
                        </div>
            ...
            <div class="col-md-3">
                <section class="pricing-section bg-12">
                    <div class="event event--user">
                        <div class="event__item">
                            <div class="event__deco">
                                <div class="event__name">Anime Fiesta <br><br><br></div>
                            </div>
                            <ul class="event__details-list">
            ...
            <div class="col-md-3">
                <section class="pricing-section bg-12">
                    <div class="event event--user">
                        <div class="event__item">
                            <div class="event__deco">
                                <div class="event__name">Line Follower <br><br> (Dark Horse)</div>
                            </div>
                            <ul class="event__details-list">
                                <li class="event__detail">Date & Time - 15-02-2020 | 10:00</li>
                                <li class="event__detail">Venue - Block 25 - Basement</li>
                            </ul>
                            <a onclick="reg_closed()" class="event__action">Register <i class="lni-add-file size-xs"></i></a>
                            <a href="https://vormiir.com/yv/rule_book/technical/CodeZilla.pdf" target="_blank" class="event__action">Rule Book <i class="lni-download size-xs"></i></a>
                        </div>
            ...
            <div class="col-md-3">
                <section class="pricing-section bg-12">
                    <div class="event event--user">
                        <div class="event__item">
                            <div class="event__deco">
                                <div class="event__name">Drone Racing <br><br><br></div>
                            </div>
                            <ul class="event__details-list">
                                <li class="event__detail">Date & Time - 14-02-2020 | 14:00</li>
                                <li class="event__detail">Venue - LPU Plaza, In front of 26 Block</li>
                            </ul>
                            <a onclick="reg_closed()" class="event__action">Register <i class="lni-add-file size-xs"></i></a>
                            <a href="https://vormiir.com/yv/rule_book/technical/CodeZilla.pdf" target="_blank" class="event__action">Rule Book <i class="lni-download size-xs"></i></a>
                        </div>
            ...
            <div class="col-md-3">
                <section class="pricing-section bg-12">
                    <div class="event event--user">
                        <div class="event__item">
                            <div class="event__deco">
                                <div class="event__name">Make-an-App <br><br><br></div>
                            </div>
                            <ul class="event__details-list">
